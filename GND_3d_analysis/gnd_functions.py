...
def dislocation_vertices_generation(dislocation_file, burgers_file, bound=None):
    ...
    temp = ast.literal_eval(dislocation_data_original)
    ...
    print('dislocation_data_withinBound=', dislocation_data_withinBound)
    print('burgers_data_withinBound=', burgers_data_withinBound)
