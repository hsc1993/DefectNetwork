function [rn,links,connectivity,linksinconnect,fseg,stackforcevec]=remesh(rn,links,connectivity,linksinconnect,fseg,lmin,lmax,areamin,areamax,MU,NU,a,Ec,appliedstress,mobility,dopartials,stackforcevec,rntol,doSFT,SFT_plane,doinclusion,inclusion_pos_rad,doshielding,SurfacePlane,dobox,boxD)
...
[rn,links,connectivity,linksinconnect,fseg,stackforcevec]=meshcoarsen(rn,links,connectivity,linksinconnect,fseg,lmin,lmax,areamin,MU,NU,a,Ec,appliedstress,mobility,dopartials,stackforcevec,rntol,doSFT,SFT_plane,doinclusion,inclusion_pos_rad,doshielding,SurfacePlane,dobox,boxD);
[rn,links,connectivity,linksinconnect,fseg,stackforcevec]=meshrefine(rn,links,connectivity,linksinconnect,fseg,lmin,lmax,areamax,MU,NU,a,Ec,appliedstress,mobility,dopartials,stackforcevec,rntol,doSFT,SFT_plane,doinclusion,inclusion_pos_rad,doshielding,SurfacePlane,dobox,boxD);
[rn]=surface(rn,SurfacePlane);


function [rnnew,linksnew,connectivitynew,linksinconnectnew,fsegnew,stackforcevecnew]=meshcoarsen(rn,links,connectivity,linksinconnect,fseg,lmin,lmax,areamin,MU,NU,a,Ec,appliedstress,mobility,dopartials,stackforcevec,rntol,doSFT,SFT_plane,doinclusion,inclusion_pos_rad,doshielding,SurfacePlane,dobox,boxD)
rnnew=rn;
[lrn lrn2]=size(rn);
linksnew=links;
                        ...
                        for j=1:connectivitynew(mergednodeid,1)
                            ...
                            if ((connode==i)|(connode==link1_nodenoti))
                                ...
                                for j=1:2
                                    ...
                                    [rnnew(nodelist,4:6),fntmp]=feval(mobility,fsegnew,rnnew,linksnew,connectivitynew,nodelist,clist,mobility,dopartials,stackforcevecnew,rntol,doSFT,SFT_plane,doinclusion,inclusion_pos_rad);
                                end    
                            end
                        end
                    end
...
function [rnnew,linksnew,connectivitynew,linksinconnectnew,fsegnew,stackforcevecnew]=meshrefine(rn,links,connectivity,linksinconnect,fseg,lmin,lmax,areamax,MU,NU,a,Ec,appliedstress,mobility,dopartials,stackforcevec,rntol,doSFT,SFT_plane,doinclusion,inclusion_pos_rad,doshielding,SurfacePlane,dobox,boxD)
[lrn lrn2]=size(rn);
lrn3=lrn2-1;
rnnew=rn;
linksnew=links;
...
%             end
            if (((area2>areamax2)&(r2>=lmin2)&(link2_nodenoti<=lrn))|(r2>lmax))
                ...
                for j=1:connectivitynew(newnode,1)
                    ...
                    [rnnew(oldnode,4:6),fntmp]=feval(mobility,fsegnew,rnnew,linksnew,connectivitynew,oldnode,clist,mobility,dopartials,stackforcevecnew,rntol,doSFT,SFT_plane,doinclusion,inclusion_pos_rad);
                end
                clist=[connectivitynew(newnode,1) linspace(1,connectivitynew(newnode,1),connectivitynew(newnode,1))];
                [rnnew(newnode,4:6),fntmp]=feval(mobility,fsegnew,rnnew,linksnew,connectivitynew,newnode,clist,mobility,dopartials,stackforcevecnew,rntol,doSFT,SFT_plane,doinclusion,inclusion_pos_rad);
            end
%             if doinclusion
%                 if(norm(rnnew(i,1:3)-inclusion_pos_rad(1,1:3))<(inclusion_pos_rad(1,4))+3 || ...
%                         norm(rnnew(link1_nodenoti,1:3)-inclusion_pos_rad(1,1:3))<(inclusion_pos_rad(1,4))+3)
