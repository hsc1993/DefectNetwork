...
MU = 81*1e-11; % shear modulus   94 GPa=94e-11 N/A^2
...
numSegs = 7; % 1->4.6A, 5-> 23A, 10->46A, 12->55A 
...
fullloop_shift_z = 40;
fraction_plim_partial = 1;
fraction_plim=1;

seglength_multiply = 1;

num_nodes_perloop = [];
rng(100*sum(clock),'philox');

% [11-1]  red
[rn,links,links_newloop,links_start_end_list,numSegs_list,existing_loops] = addnewloop_main(plim,numloops1,range_numSegs_list,numSegs_list,SurfacePlane,n1list,b1,rn,links,links_start_end_list,partialloop_initialz(1),existing_loops,fraction_plim_partial,seglength_multiply);

% [-1-1-1]  blue
[rn,links,links_newloop,links_start_end_list,numSegs_list,existing_loops] = addnewloop_main(plim,numloops2,range_numSegs_list,numSegs_list,SurfacePlane,n2list,b2,rn,links,links_start_end_list,partialloop_initialz(2),existing_loops,fraction_plim_partial,seglength_multiply);

% [1-11]  green
[rn,links,links_newloop,links_start_end_list,numSegs_list,existing_loops] = addnewloop_main(plim,numloops3,range_numSegs_list,numSegs_list,SurfacePlane,n3list,b3,rn,links,links_start_end_list,partialloop_initialz(3),existing_loops,fraction_plim_partial,seglength_multiply);

% [-111]  yellow
[rn,links,links_newloop,links_start_end_list,numSegs_list,existing_loops] = addnewloop_main(plim,numloops4,range_numSegs_list,numSegs_list,SurfacePlane,n4list,b4,rn,links,links_start_end_list,partialloop_initialz(4),existing_loops,fraction_plim_partial,seglength_multiply);
