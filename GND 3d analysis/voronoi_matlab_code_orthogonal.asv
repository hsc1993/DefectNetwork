...
m = 0;  % partition number for cell edge length from lowlim to highlim 
...
for jj = 1:m+1
    x_distance = x_boxsize/(nx_middle_cell);
    y_distance = y_boxsize/(ny_middle_cell);
    z_distance = z_boxsize/(nz_middle_cell);
