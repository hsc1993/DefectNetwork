...
4. Generating **GND signal 3D map** with [voro_plot.m](voro_plot.m) and [result](orthogonal_merged20_voro_color.txt) is rendered in [3d_rendering.py](GND rendering/3d_rendering.py) for final 3d image of GND signal near the GB.
