...
2. Generating **cubic volume tessellation** with the [tessellation_orthogonal.m](tessellation_orthogonal.m). The [output](n20_vorvx0) contains all the vertices of each volume element. 
